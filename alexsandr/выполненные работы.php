...
<div class=labs>
    ...
    <a href="mldmlab1.php">Вторая лабораторная работа по МЛиДМ</a> <br>
    <a href="mldmlab1.php">третья лабораторная работа по МЛиДМ</a> <br>
    <a href="mldmlab1.php">четвертая лабораторная работа по МЛиДМ</a> <br>
    <a href="mldmlab1.php">пятая лабораторная работа по МЛиДМ</a> <br>
</div>
